...
(function() {
  ...
  function initJpgToWordView() {
    console.log('Initializing JPG to Word view');
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initJpgToWordView);
  } else {
    initJpgToWordView();
  }

  // Export for potential external use
  window.initJpgToWordView = initJpgToWordView;

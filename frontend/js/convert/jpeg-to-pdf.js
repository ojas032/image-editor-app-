...
(function() {
  ...
  // DOM elements (will be set in initJpegToPdfView)
  let canvas = null;
  ...
  function initJpegToPdfView() {
    ...
    if (selectBtn) {
      console.log('selectBtn element:', selectBtn);
      console.log('selectBtn style:', selectBtn.style);
    }
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initJpegToPdfView);
  } else {
    // Small delay to ensure all elements are rendered
    setTimeout(initJpegToPdfView, 100);
  }

  // Export for potential external use
  window.initJpegToPdfView = initJpegToPdfView;

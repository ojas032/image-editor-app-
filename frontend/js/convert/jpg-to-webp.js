...
(function() {
  ...
  function initJpgToWebpView() {
    console.log('Initializing JPG to WebP view');
    ...
    if (canvasContainer) {
      ...
      newConvertBtn.addEventListener('click', async () => {
        ...
        try {
          ...
          const convertedBlob = await convertImageLocally(canvas, 'webp');
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initJpgToWebpView);
  } else {
    initJpgToWebpView();
  }

  // Export for potential external use
  window.initJpgToWebpView = initJpgToWebpView;

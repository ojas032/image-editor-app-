...
(function() {
  ...
  function initWebpToPngView() {
    console.log('Initializing WebP to PNG view');
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initWebpToPngView);
  } else {
    initWebpToPngView();
  }

  // Export for potential external use
  window.initWebpToPngView = initWebpToPngView;

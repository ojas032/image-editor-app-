...
(function() {
  ...
  function initPngToWebpView() {
    console.log('Initializing PNG to WebP view');
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initPngToWebpView);
  } else {
    initPngToWebpView();
  }

  // Export for potential external use
  window.initPngToWebpView = initPngToWebpView;

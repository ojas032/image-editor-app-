...
(function() {
  ...
  function initJpgToExcelView() {
    console.log('Initializing JPG to Excel view');
...
- Try using a different browser or device`;
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initJpgToExcelView);
  } else {
    initJpgToExcelView();
  }

  // Export for potential external use
  window.initJpgToExcelView = initJpgToExcelView;

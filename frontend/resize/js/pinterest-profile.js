...
(function() {
  ...
  function initPinterestpinterestUprofilePage() {
  ...
  function setupYouTubeThumbnailFunctionality() {
    ...
    const PINTEREST_PINTEREST_PROFILE_PRESET = {
      name: 'Profile Picture (165 × 165)',
      width: 165,
      height: 165
    };
    ...
    function updateDimensionsDisplay() {
      ...
      if (dimensionsEl) {
        dimensionsEl.textContent = `Original: ${originalWidth} × ${originalHeight} → YouTube Thumbnail: ${PINTEREST_PINTEREST_PROFILE_PRESET.width} × ${PINTEREST_PINTEREST_PROFILE_PRESET.height}`;
      }
    }
    ...
    async function handleExport() {
      ...
      try {
        ...
        const requestData = {
          image: currentBase64,
          width: PINTEREST_PINTEREST_PROFILE_PRESET.width,
          height: PINTEREST_PINTEREST_PROFILE_PRESET.height,
          format: 'jpeg',
          quality: 95
        };
        ...
        downloadBtn.download = `pinterest-profile-${Date.now()}.jpg`;

        // Update success dimensions
        const successDimensions = document.getElementById('resizeSuccessDimensions');
        if (successDimensions) {
          successDimensions.textContent = `Resized to: ${PINTEREST_PINTEREST_PROFILE_PRESET.width} × ${PINTEREST_PINTEREST_PROFILE_PRESET.height} pixels`;
        }
  ...
  window.initPinterestpinterestUprofilePage = initPinterestpinterestUprofilePage;

...
(function() {
  ...
  function initPinterestpinterestUboardUdisplayUlargePage() {
  ...
  function setupYouTubeThumbnailFunctionality() {
    ...
    const PINTEREST_PINTEREST_BOARD_DISPLAY_LARGE_PRESET = {
      name: 'Board Display Large (1000 × 1500)',
      width: 1000,
      height: 1500
    };
    ...
    function updateDimensionsDisplay() {
      ...
      if (dimensionsEl) {
        dimensionsEl.textContent = `Original: ${originalWidth} × ${originalHeight} → YouTube Thumbnail: ${PINTEREST_PINTEREST_BOARD_DISPLAY_LARGE_PRESET.width} × ${PINTEREST_PINTEREST_BOARD_DISPLAY_LARGE_PRESET.height}`;
      }
    }
    ...
    async function handleExport() {
      ...
      try {
        ...
        const requestData = {
          image: currentBase64,
          width: PINTEREST_PINTEREST_BOARD_DISPLAY_LARGE_PRESET.width,
          height: PINTEREST_PINTEREST_BOARD_DISPLAY_LARGE_PRESET.height,
          format: 'jpeg',
          quality: 95
        };
        ...
        downloadBtn.download = `pinterest-board-display-large-${Date.now()}.jpg`;

        // Update success dimensions
        const successDimensions = document.getElementById('resizeSuccessDimensions');
        if (successDimensions) {
          successDimensions.textContent = `Resized to: ${PINTEREST_PINTEREST_BOARD_DISPLAY_LARGE_PRESET.width} × ${PINTEREST_PINTEREST_BOARD_DISPLAY_LARGE_PRESET.height} pixels`;
        }
  ...
  window.initPinterestpinterestUboardUdisplayUlargePage = initPinterestpinterestUboardUdisplayUlargePage;

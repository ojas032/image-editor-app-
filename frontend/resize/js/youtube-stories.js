/**
 * YouTube Stories page JavaScript functionality
 * Handles image resizing operations with YouTube Stories preset pre-selected
 */
...
(function() {
  ...
  // YouTube Stories page initialization
  function initYouTubeStoriesPage() {
    console.log('YouTube Stories page initialized');
    ...
    // Initialize resize functionality with YouTube Stories preset
    setupYouTubeStoriesFunctionality();
  }

  function setupYouTubeStoriesFunctionality() {
    // YouTube Stories preset
    const YOUTUBE_STORIES_PRESET = {
    ...
    // Update dimensions display for YouTube Stories
    function updateDimensionsDisplay() {
      const dimensionsEl = document.getElementById('resizeImageDimensions');
      if (dimensionsEl) {
        dimensionsEl.textContent = `Original: ${originalWidth} × ${originalHeight} → YouTube Stories: ${YOUTUBE_STORIES_PRESET.width} × ${YOUTUBE_STORIES_PRESET.height}`;
      }
    }
    ...
    async function handleExport() {
      ...
      try {
        ...
        if (successDimensions) {
          successDimensions.textContent = `Resized to: ${YOUTUBE_STORIES_PRESET.width} × ${YOUTUBE_STORIES_PRESET.height} pixels`;
        }
  ...
  window.initYouTubeStoriesPage = initYouTubeStoriesPage;

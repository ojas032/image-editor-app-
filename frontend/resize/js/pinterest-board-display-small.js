...
(function() {
  ...
  function initPinterestpinterestUboardUdisplayUsmallPage() {
  ...
  function setupYouTubeThumbnailFunctionality() {
    ...
    const PINTEREST_PINTEREST_BOARD_DISPLAY_SMALL_PRESET = {
      name: 'Board Display Small (222 × 300)',
      width: 222,
      height: 300
    };
    ...
    function updateDimensionsDisplay() {
      ...
      if (dimensionsEl) {
        dimensionsEl.textContent = `Original: ${originalWidth} × ${originalHeight} → YouTube Thumbnail: ${PINTEREST_PINTEREST_BOARD_DISPLAY_SMALL_PRESET.width} × ${PINTEREST_PINTEREST_BOARD_DISPLAY_SMALL_PRESET.height}`;
      }
    }
    ...
    async function handleExport() {
      ...
      try {
        ...
        const requestData = {
          image: currentBase64,
          width: PINTEREST_PINTEREST_BOARD_DISPLAY_SMALL_PRESET.width,
          height: PINTEREST_PINTEREST_BOARD_DISPLAY_SMALL_PRESET.height,
          format: 'jpeg',
          quality: 95
        };
        ...
        downloadBtn.download = `pinterest-board-display-small-${Date.now()}.jpg`;

        // Update success dimensions
        const successDimensions = document.getElementById('resizeSuccessDimensions');
        if (successDimensions) {
          successDimensions.textContent = `Resized to: ${PINTEREST_PINTEREST_BOARD_DISPLAY_SMALL_PRESET.width} × ${PINTEREST_PINTEREST_BOARD_DISPLAY_SMALL_PRESET.height} pixels`;
        }
  ...
  window.initPinterestpinterestUboardUdisplayUsmallPage = initPinterestpinterestUboardUdisplayUsmallPage;

...
(function() {
  ...
  function initLinkedInlinkedinUcompanyUlogoPage() {
  ...
  function setupYouTubeThumbnailFunctionality() {
    ...
    const LINKEDIN_LINKEDIN_COMPANY_LOGO_PRESET = {
      name: 'Company Logo (300 × 300)',
      width: 300,
      height: 300
    };
    ...
    function updateDimensionsDisplay() {
      ...
      if (dimensionsEl) {
        dimensionsEl.textContent = `Original: ${originalWidth} × ${originalHeight} → YouTube Thumbnail: ${LINKEDIN_LINKEDIN_COMPANY_LOGO_PRESET.width} × ${LINKEDIN_LINKEDIN_COMPANY_LOGO_PRESET.height}`;
      }
    }
    ...
    async function handleExport() {
      ...
      try {
        ...
        const requestData = {
          image: currentBase64,
          width: LINKEDIN_LINKEDIN_COMPANY_LOGO_PRESET.width,
          height: LINKEDIN_LINKEDIN_COMPANY_LOGO_PRESET.height,
          format: 'jpeg',
          quality: 95
        };
        ...
        downloadBtn.download = `linkedin-company-logo-${Date.now()}.jpg`;

        // Update success dimensions
        const successDimensions = document.getElementById('resizeSuccessDimensions');
        if (successDimensions) {
          successDimensions.textContent = `Resized to: ${LINKEDIN_LINKEDIN_COMPANY_LOGO_PRESET.width} × ${LINKEDIN_LINKEDIN_COMPANY_LOGO_PRESET.height} pixels`;
        }
  ...
  window.initLinkedInlinkedinUcompanyUlogoPage = initLinkedInlinkedinUcompanyUlogoPage;

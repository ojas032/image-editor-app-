...
(function() {
  ...
  function initLinkedInlinkedinUcompanyUcoverPage() {
  ...
  function setupYouTubeThumbnailFunctionality() {
    ...
    const LINKEDIN_LINKEDIN_COMPANY_COVER_PRESET = {
      name: 'Company Cover (1536 × 768)',
      width: 1536,
      height: 768
    };
    ...
    function updateDimensionsDisplay() {
      ...
      if (dimensionsEl) {
        dimensionsEl.textContent = `Original: ${originalWidth} × ${originalHeight} → YouTube Thumbnail: ${LINKEDIN_LINKEDIN_COMPANY_COVER_PRESET.width} × ${LINKEDIN_LINKEDIN_COMPANY_COVER_PRESET.height}`;
      }
    }
    ...
    async function handleExport() {
      ...
      try {
        ...
        const requestData = {
          image: currentBase64,
          width: LINKEDIN_LINKEDIN_COMPANY_COVER_PRESET.width,
          height: LINKEDIN_LINKEDIN_COMPANY_COVER_PRESET.height,
          format: 'jpeg',
          quality: 95
        };
        ...
        downloadBtn.download = `linkedin-company-cover-${Date.now()}.jpg`;

        // Update success dimensions
        const successDimensions = document.getElementById('resizeSuccessDimensions');
        if (successDimensions) {
          successDimensions.textContent = `Resized to: ${LINKEDIN_LINKEDIN_COMPANY_COVER_PRESET.width} × ${LINKEDIN_LINKEDIN_COMPANY_COVER_PRESET.height} pixels`;
        }
  ...
  window.initLinkedInlinkedinUcompanyUcoverPage = initLinkedInlinkedinUcompanyUcoverPage;

...
(function() {
  ...
  function initTwittertwitterUprofileUphotoPage() {
  ...
  function setupYouTubeThumbnailFunctionality() {
    ...
    const TWITTER_TWITTER_PROFILE_PHOTO_PRESET = {
      name: 'Profile Photo (400 × 400)',
      width: 400,
      height: 400
    };
    ...
    function updateDimensionsDisplay() {
      ...
      if (dimensionsEl) {
        dimensionsEl.textContent = `Original: ${originalWidth} × ${originalHeight} → YouTube Thumbnail: ${TWITTER_TWITTER_PROFILE_PHOTO_PRESET.width} × ${TWITTER_TWITTER_PROFILE_PHOTO_PRESET.height}`;
      }
    }
    ...
    async function handleExport() {
      ...
      try {
        ...
        const requestData = {
          image: currentBase64,
          width: TWITTER_TWITTER_PROFILE_PHOTO_PRESET.width,
          height: TWITTER_TWITTER_PROFILE_PHOTO_PRESET.height,
          format: 'jpeg',
          quality: 95
        };
        ...
        downloadBtn.download = `twitter-profile-photo-${Date.now()}.jpg`;

        // Update success dimensions
        const successDimensions = document.getElementById('resizeSuccessDimensions');
        if (successDimensions) {
          successDimensions.textContent = `Resized to: ${TWITTER_TWITTER_PROFILE_PHOTO_PRESET.width} × ${TWITTER_TWITTER_PROFILE_PHOTO_PRESET.height} pixels`;
        }
  ...
  window.initTwittertwitterUprofileUphotoPage = initTwittertwitterUprofileUphotoPage;
